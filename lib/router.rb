...
# on veut qu'un Routeur.new lancé par app.rb créé automatiquement une insstance "@controller"
...
# rappel toi que l'on fait Router.new.perform dans app.rb =>apres initialize, on definit donc perform
